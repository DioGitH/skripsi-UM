    ...
    <div class=" ">
        <div class="eskilllib-banner">
            <div class="eskilllib-text">
                e Skill-Lib adalah platform repository digital berbasis web yang dikembangkan untuk mendukung penyimpanan, pengelolaan, dan publikasi karya keahlian/ Skill dari siswa di SMKN 3 Malang secara praktis, informatif, dan mudah diakses.
            </div>
        </div>
            ...
            <div class="about-right about-section">
                <div class="p-5 bg-white">
                    ...
                    <div class="d-flex flex-column gap-2 mt-4">
                        ...
                        <div style="font-family: 'Instrument Sans', sans-serif; font-size: 22px">Ahmad Rijal Pahlevi (085732741256)</div>
                    </div>
                </div>
                <div class="mb-4 mt-5">
