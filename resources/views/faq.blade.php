...
@section('content')
        ...
        <div class="faq-container">
            <div class="faq-item">
                ...
                <div class="faq-item-text">e Skill-Lib Repository merupakan sebuah website yang berperan sebagai wadah penyimpanan, pengelolaan, dan publikasi karya dari siswa secara digital.</div>
            </div>
            <div class="faq-item">
            ...
            <div class="faq-item">
                ...
                <div class="faq-item-text">Website ini dapat diakses kapan saja dan di mana saja selama pengguna terhubung dengan internet, sehingga tidak terbatas
                hanya di lingkungan sekolah</div>
            </div>
        </div>
